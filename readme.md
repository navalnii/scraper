Простое веб-приложение на flask для получения выборки из test.xml с расчетами общего время пребывания.
...
4) Продемонстрировать работу с помощью тестов.
	-Приложение работает даже если не заполнить какие-либо поля.
